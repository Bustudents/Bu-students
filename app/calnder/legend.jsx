const EventLegend = () => {
  const legendItems = [
    ...
    { color: "bg-red-500", label: "Assignment Due  3 days or less" },
    { color: "bg-blue-500", label: "Upcoming Assignment " },
    { color: "bg-gray-400", label: "General Event" },
  ];

  return (
    <div className="bg-gray-800  text-white p-4 ml-0 rounded-lg shadow-md w-[300px] max-w-md">
      <h3 className="text-lg font-bold mb-3">Event Color Guide</h3>
