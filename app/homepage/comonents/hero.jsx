...
export const Hero = ({stat}) => {
  ...
  <div key={stat.id}   className="flex flex-col justify-start">  <div className=" flex row  "><h2 className="">Faculty of</h2> <h2 className="text-[#FA0000]">Business</h2> </div>   <h2>administration</h2></div>

    </div>
<div className="2xl:pt-44 flex flex-col xs:pt-[150px] items-center  justify-center">

<div className="2xl:hidden   xs:ml-10 lg:ml-0 items-center justify-center  xs:visible flex flex-col  pt-20 text-[40px] font-extrabold"><div>faculty of</div> <div className=" Buss  ">
  Business 
</div>
...
<div className="flex  xs:ml-12 lg:ml-0 z-5 flex-row justify-center items-center  xs:scale-75 2xl:scale-100 2xl:pt-0 xs:pt-10  ">
 ...
 <h1 className=" stat font-extrabold text-[20px] 2xl:text-[20px] xs:text-[15px]"> {stat.Batches } </h1>
 ...
 <div className="flex items-center z-5 justify-center flex-col 2xl:mr-5 xs:mr-0 ">
  ...
  <h1 className="stat 2xl:text-[20px] xs:text-[15px] font-extrabold "> {stat.bachler} +</h1>
   ...
   <div className=" flex flex-row m-5 justify-center items-center mb-1">
   <h1 className=" stat text-[20px] font-extrabold 2xl:text-[20px] xs:text-[14px]"> {stat.master} +</h1>
